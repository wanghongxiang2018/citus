...
/*
 * IsReferenceJoin checks if with this join type we can safely do a simple join
 * on the reference table on all the workers.
 */
bool
IsReferenceJoin(JoinType joinType, bool leftIsReferenceTable, bool rightIsReferenceTable)
{
